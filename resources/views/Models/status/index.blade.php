...
<div id="paginationContainer">
    <ul class="pagination">
        <li class="page-item"><a class="page-link" href="{{ $statuses->previousPageUrl() }}">{{ __('pagination.previous') }}</a></li>
        @foreach ($statuses->links()->elements[0] as $index => $link )
            ...
            @endif
        @endforeach
        <li class="page-item"><a class="page-link" href="{{ $statuses->nextPageUrl()}}">{{ __('pagination.next') }}</a></li>
    </ul>
</div>
