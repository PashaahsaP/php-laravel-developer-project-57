...
<div id="paginationContainer">
    <ul class="pagination">
        <li class="page-item"><a class="page-link" href="{{ $marks->previousPageUrl() }}">{{ __('pagination.previous') }}</a></li>
        @foreach ($marks->links()->elements[0] as $index => $link )
            ...
            @endif
        @endforeach
        <li class="page-item"><a class="page-link" href="{{ $marks->nextPageUrl()}}">{{ __('pagination.next') }}</a></li>
    </ul>
</div>
